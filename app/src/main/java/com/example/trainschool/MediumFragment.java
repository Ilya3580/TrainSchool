...
public class MediumFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        home.setOnClickListener(v -> {
            navController.navigate(R.id.action_fragment_medium_to_fragment_main_screen);
        });

        trener.setOnClickListener(v -> {
            navController.navigate(R.id.action_fragment_medium_to_fragment_trener_description);
        });
        schedule.setOnClickListener(v -> {
            navController.navigate(R.id.action_fragment_medium_to_fragment_schedule_basic);
        });
        profile.setOnClickListener(v -> {
            navController.navigate(R.id.action_fragment_medium_to_fragment_profile);
        });
